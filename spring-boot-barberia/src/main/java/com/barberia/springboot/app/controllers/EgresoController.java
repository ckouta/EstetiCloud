...
public class EgresoController {
	...
	private IServicioService servicioService;
	 //listar servicios
		...
		public String listar(Model model) {
			model.addAttribute("titulo", "Listado de egreso");
	...
	public String editar(@PathVariable(value="id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		model.put("servicio", servicio);
		model.put("titulo", "Editar egreso");
		return "reserva/form";
	}
	//guardar servicio
	...
	public String guardar(@Valid Servicio servicio, BindingResult result, Model model, RedirectAttributes flash, SessionStatus status) {
		...
		String mensajeFlash = (servicio.getId() != null)? "Egreso editado con éxito!" : "Egreso creado con éxito!";
	...
	public String eliminar(@PathVariable(value="id") Long id, RedirectAttributes flash) {
		if(id > 0) {
			...
			flash.addFlashAttribute("success", "Egreso eliminado con éxito!");
		}
		return "redirect:/reserva/listar";
	}
}
