...
public class IngresoController {
	...
	private IServicioService servicioService;
	 //listar servicios
		...
		public String listar(Model model) {
			model.addAttribute("titulo", "Listado de ingreso");
	...
	public String crear(Map<String, Object> model) {
		...
		model.put("titulo", "Crear ingreso");
		return "reserva/form";
	}
	//editar servicio
	...
	public String editar(@PathVariable(value="id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		model.put("servicio", servicio);
		model.put("titulo", "Editar ingreso");
		return "reserva/form";
	}
	//guardar servicio
	...
	public String guardar(@Valid Servicio servicio, BindingResult result, Model model, RedirectAttributes flash, SessionStatus status) {
		...
		if (result.hasErrors()) {
			model.addAttribute("titulo", "Crear ingreso");
			return "reserva/form";
		}
		String mensajeFlash = (servicio.getId() != null)? "Ingreso editado con éxito!" : "Ingreso creado con éxito!";
	...
	public String eliminar(@PathVariable(value="id") Long id, RedirectAttributes flash) {
		if(id > 0) {
			...
			flash.addFlashAttribute("success", "Ingreso eliminado con éxito!");
		}
		return "redirect:/reserva/listar";
	}
}
